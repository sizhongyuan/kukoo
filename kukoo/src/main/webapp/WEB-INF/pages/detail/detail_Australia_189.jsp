								...
								<div class="row" style="margin-top:30px">
									...
									<div class="col-xs-9 row-margin detail-width">
										<p style="margin: 0 0 -2px;">
											澳大利亚Skilled Independent visa (subclass 189) (Points-tested) stream，俗称独立技术移民，不需要州担保
											、雇主以及亲属担保就可以申请。申请189签证成功后可以无限期居住在澳洲，申请人及其家人可以在这里作为永久居民去工作、学
											习、加入医疗保险、担保亲属、申请澳大利亚国籍等。
										</p>
									</div>
								</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-md-9" style="font-size: 13px;">
						...
						<div id="heading" class="bs-docs-section mb-100" style="margin-top: 25px;">
							...
							<p style="margin-top:-20px;">澳大利亚Skilled Independent visa (subclass 189) (Points-tested) stream，俗称独立技术移民
							，不需要州担保、雇主以及亲属担保就可以申请。申请189签证成功后可以无限期居住在澳洲，申请人及其家人可以在这里作为永久居民去工作、学习、加
							入医疗保险、担保亲属、申请澳大利亚国籍等。</p>
						...
						<div id="dropcaps" class="bs-docs-section mb-100">
							<div class="heading-underline h3-line">
								<h3 class="mb-40">申请流程</h3>
									...
									<p class="font-bold" style="margin-top:-20px;">189签证类别申请流程​</p>
									<p>1 确认EOI评分达到60分（包含州担保5分）；</p>
									<p>&nbsp;&nbsp;&nbsp;60分只是入池分数，某些职业可能需要65甚至更高分数才能获邀</p>
									<p>2 选择合适的职业，并通过对应职业的职业评估；</p>
									<p>3 注册并提交EOI，等待被邀请；</p>
									<p>4 收到签证邀请，60天内递交签证申请，在线支付申请费</p>
									<p>5 体检通知，配偶交语言费、补料等；</p>
					...
					<table class="table table-striped mb-40">
						...
						<p class="font-bold" style="margin-top:-20px;">189签证申请条件</p>
						<p>1 申请189签证的前提是职业在MLTSSL上；</p>
						<p>2 EOI评分达到60分；</p>
						<p>3 年龄小于45岁；</p>
						<p>4	 通过职业评估</p>
						<p>5 提交EOI，并获得邀请；</p>
						<p>6 雅思达到4个6的 Competent English 成绩，成绩三年内有效；</p>
						<p>7 身体健康，品行良好，无犯罪记录。</p>
						<p class="font-bold">* 189签证评分标准</p>
