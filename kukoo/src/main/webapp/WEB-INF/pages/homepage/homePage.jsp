					...
					<div class="rev_slider fullscreenbanner" data-version="5.1.4"
						...
						<ul>
							...
							<li data-description="" data-easein="Power2.easeInOut"
								...
								data-no-retina="" src="<%=basePath %>elementy/images/revo-slider/index18.jpg"> <!-- LAYERS -->
								<!-- LAYER NR. 1 -->
								<div
						...
						<div class="col-md-3 col-sm-3 widget">
							<div class="logo-footer-cont">
								<a href="index.html"> <img class="logo-footer"
									src="<%=basePath %>elementy/images/logo-footer-white.png" alt="logo">
								</a>
							</div>
							...
							<div class="footer2-text-cont a-text-main-cont">
								<a class="popup-gmaps mfp-plugin font-raleway"
								...
								<div id="mc_embed_signup" class="nl-form-container clearfix">
									<form
										...
										<input type="email" value="" name="EMAIL"
											class="email nl2-email-input font-raleway" id="mce-EMAIL"
