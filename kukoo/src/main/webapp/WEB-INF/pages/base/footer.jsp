	...
	<div class="container">
			...
			<div class="col-md-3 col-sm-3 widget">
				...
				<ul class="links-list a-text-cont font-poppins">
					...
					<li><a href="https://help.market.envato.com/hc/en-us">Help
							Center</a></li>
					<li><a href="http://themeforest.net/legal/market">Terms of
							Service</a></li>
					...
					<div id="mc_embed_signup" class="nl-form-container clearfix">
						<form
							...
							<div style="position: absolute; left: -5000px;">
								<input type="text" name="b_ba37086d08bdc9f56f3592af0_e38247f7cc"
									tabindex="-1" value="">
							</div>

							<button id="mc-embedded-subscribe" class="nl2-btn" type="submit"
								name="subscribe">
		...
		<div class="footer2-copy-cont clearfix">
			...
			<div class="footer2-soc-a right">
				...
				<a
					href="http://themeforest.net/user/abcgomel/portfolio?ref=abcgomel"
					title="Twitter" target="_blank"><i class="fa fa-twitter"></i></a> <a
					href="https://www.behance.net/abcgomel" title="Behance"
